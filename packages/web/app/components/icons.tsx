...
export const IconQuestions = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
    <circle cx="12" cy="12" r="9" />
    <path d="M9.2 9.2a2.8 2.8 0 0 1 5.3 1c0 1.8-2.7 2.2-2.7 4" />
...
export const IconContracts = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
    ...
    <path d="M14 3v5h5" />
    <path d="M9.5 13l-1.5 1.5L9.5 16" />
    <path d="M14.5 13l1.5 1.5-1.5 1.5" />
  </svg>
);
export const IconDependencies = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
    ...
    <path d="M7.6 8l3 7.5M16.4 8l-3 7.5M8.5 6h7" />
  </svg>
);
...
export const IconMembers = (p: SVGProps<SVGSVGElement>) => (
  <svg {...base(p)}>
    ...
    <path d="M16 5.5a3 3 0 0 1 0 5.8M21 19a5 5 0 0 0-4-4.9" />
  </svg>
);
